...
; filename: codeExample7-1.orc
; Reads an audio file into table so samples can be used as FreqMods
; NB this is the .orc file for the example, i.e. it contains only the orchestra
; A score file is necessary to run it in csound, typically 
; $ csound codeExample7-1.orc xxx.sco
; where xxx.sco is the score file
; a unified .csd file of this orchestra can also be found in this directory
;  to which a score can be added in the usual place.
